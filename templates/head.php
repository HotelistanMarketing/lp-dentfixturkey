<head>
    ...
    <link rel="preload" as="style" href="<?= dirname($_SERVER['SCRIPT_FILENAME']) ?>/critic.css">
    <link rel="stylesheet" href="<?= dirname($_SERVER['SCRIPT_FILENAME']) ?>critic.css">
    <link rel="stylesheet" href="<?= dirname($_SERVER['SCRIPT_FILENAME']) ?>style.css">
