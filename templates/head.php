<head>
    ...
    <link rel="preload" as="style" href="/public/implant/style.css">
    <link rel="stylesheet" href="/public/implant/style.css">
    ...
    <style><?php include($_SERVER['DOCUMENT_ROOT'] . '/public/implant/critic.css') ?></style>
