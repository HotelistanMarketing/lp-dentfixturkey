...
const TR = array(
    "page_title" => "Dubai Dental Clinic in Dubai | DentfixDubai",
    "page_keywords" => "dental clinic, Dubai, veneers, crowns, hollywood smile, restorative dentistry",
    "page_description" => "Our expert team of dentists offers a wide range of services for a beautiful and healthy smile. Schedule your appointment today and experience exceptional dental care at Dubai Dental Teeth Clinic - DentfixDubai.",
    ...
    // HERO
    "hero_title" => "Dental Clinic <span>in Dubai</span>",
    "hero_title_mobile" => "Dental Clinic <br><span>in Dubai</span>",
    "hero_subtitle" => "Enhance Your Smile<br>with Dentfix Clinic’s Affordable Services",
    ...
    "services_details" => array(
        ...
        [
            "Hollywood Smile",
            "Experience a transformative smile makeover with our advanced techniques and expertise.<br>Enjoy a smooth and comfortable Hollywood Smile Dubai Recovery process, ensuring your well-being throughout."
        ],
        [
    ...
    // TEAM
    "team_title" => "Our Team",
    "team_description" => "Meet our team of experienced and skilled professionals who are dedicated to providing you with the best dental care.",
    "team_details" => array(
        [
            "Doc. Dr. Ayşe ATAY",
            "/assets/dt-ayse.webp"
    ...
    "package_details" => array(
        ...
        [
            "Airport Transfer",
            "Arriving in Dubai?  Leave the logistics to us. Our dedicated team will take care of your airport pickup and local transportation needs, offering a fleet of luxurious minivans for your comfort and convenience."
        ],
        [
            "Accommodation",
            "Experience exclusivity at our centrally located hotels in Dubai and our partnered first-class establishments. Discover unparalleled opportunities for a memorable stay."
        ],
        [
            "Sightseeing Tour",
            "Uncover the captivating beauty of Dubai, a truly remarkable destination. Maximize your experience with our guided tours and translation services, immersing yourself in unforgettable moments."
        ],
        [
            "Post-Op Care",
