...
define('TR', array(
    ...
    "services_details" => array(
        ["Dental Implants",
            "The Mini Brazilian Butt Lift is a specialized procedure that involves the removal and transfer of fat from two liposuction zones to achieve a more subtle enhancement of the buttocks."],
        ["Dental Veneers",
            "The Plus Size Brazilian Butt Lift is a type of cosmetic surgery that utilizes the patient's own body fat to enhance the size and shape of their buttocks. It is intended for those with a body mass index ranging from 30 to 35."],
        ["Dental Crowns",
            "Non-surgical Brazilian Butt Lift typically involves the injections of a silicone-like material. It can be achieved through non-invasive or minimally invasive techniques such as injectable dermal fillers or radio frequency treatments."],
        ["Hollywood Smile",
            "Hourglass BBL is a specific type of Brazilian Butt Lift that aim to enhance the curves of the body. Fat transfers to the buttocks, creating a more defined waistline and a fuller, curvier buttock shape, resulting in a more hourglass-like figure."],
