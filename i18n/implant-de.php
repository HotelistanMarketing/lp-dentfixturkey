...
const TR = array(
    ...
    "whatsapp_message" => "Hallo, ich würde gerne mehr über die Dienstleistungen und Preise 
%s in der Türkei erfahren.",

    // HEADER
    "nav_menu" => array(
        "why" => "Warum auswählen",
        "before-after" => "Vorher / Nachher",
        "influencers" => "Influencer:in",
        "services" => "Services",
        "team" => "Unser Team",
    ...
    "why" => array(
        "<strong>Hochmoderne Technologie</strong>",
        "<strong>All In One</strong> Dienste",
        "<strong>+15780</strong> Glückliche Patienten",
        "<strong>+17 Jahre</strong> Erfahrung",
...
",
    ...
    "ba_button" => "Erhalten Sie die beste zahnärztliche Behandlung.",

    // TEAM
    "team_title" => "Unser Team",

    // CALL TO ACTION
    "cta_title" => "Kostenlose Online-Beratung",
    "cta_subtitle" => "Virtuelle Beratung:",
    "cta_description" => "Treten Sie vor Ihrem Eingriff mit uns in Verbindung, um ein persönliches Vorgespräch zu vereinbaren",
    ...
    "package_details" => array(
        ...
        ["VIP-Flughafentransfer",
            "Kommen Sie in Istanbul an und überlassen Sie uns die Logistik. Unser engagiertes Team kümmert sich um Ihre Abholung am Flughafen und Ihre örtlichen Transportbedürfnisse und bietet eine Flotte luxuriöser VIP-Minivans für Ihren Komfort und Ihre Bequemlichkeit."],
        ["Unterkunft",
